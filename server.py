...
@flask_server.route('/load/<database_name>/<collection_name>/<document_id>')
def load_document(database_name, collection_name, document_id):
...
@flask_server.route('/load/<database_name>')
